...
BattleMoveAnims['malepico'] = {anim: BattleMoveAnims['drillpeck'].anim};
BattleMoveAnims['nonallamas'] = {anim: BattleMoveAnims['populationbomb'].anim};
BattleMoveAnims['nonaesquirla'] = {anim: BattleMoveAnims['iciclecrash'].anim};
BattleMoveAnims['pinzainfecciosa'] = {anim: BattleMoveAnims['xscissor'].anim};
BattleMoveAnims['monolito'] = {anim: BattleMoveAnims['gigaimpact'].anim};
BattleMoveAnims['tripico'] = {anim: BattleMoveAnims['doublekick'].anim};
BattleMoveAnims['colmilloburbuja'] = {anim: BattleMoveAnims['fishiousrend'].anim};
BattleMoveAnims['mordidadragon'] = {anim: BattleMoveAnims['crunch'].anim};
BattleMoveAnims['bombapegajosa'] = {anim: BattleMoveAnims['stickyweb'].anim};
BattleMoveAnims['ritoancestralquagsire'] = {anim: BattleMoveAnims['aquaring'].anim};
BattleMoveAnims['ritoancestralslowking'] = {anim: BattleMoveAnims['simplebeam'].anim};
BattleMoveAnims['ritoancestralwungsparce'] = {anim: BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['ritoancestralgranbull'] = {anim: BattleMoveAnims['bulkup'].anim};
BattleMoveAnims['ritoancestralursaring'] = {anim: BattleMoveAnims['defendorder'].anim};
BattleMoveAnims['ritoancestralmantine'] = {anim: BattleMoveAnims['tailwind'].anim};
BattleMoveAnims['ritoancestralkingdra'] = {anim: BattleMoveAnims['lockon'].anim};
BattleMoveAnims['ritoancestraldonphan'] = {anim: BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['ritoancestralcelebi'] = {anim: BattleMoveAnims['extremeevoboost'].anim};
BattleMoveAnims['bloqueooculto'] = {anim: BattleMoveAnims['barrier'].anim};
BattleMoveAnims['aumentosecreto'] = {anim: BattleMoveAnims['painsplit'].anim};
BattleMoveAnims['esferaciclon'] = {anim: BattleMoveAnims['aeroblast'].anim};
BattleMoveAnims['astarcilla'] = {anim: BattleMoveAnims['hornleech'].anim};
BattleMoveAnims['enredodiscreto'] = {anim: BattleMoveAnims['withdraw'].anim};
BattleMoveAnims['reintegracionsecreta'] = {anim: BattleMoveAnims['refresh'].anim};
BattleMoveAnims['caparazoninestable'] = {anim: BattleMoveAnims['explosion'].anim};
BattleMoveAnims['bombatintarefinada'] = {anim: BattleMoveAnims['octazooka'].anim};
