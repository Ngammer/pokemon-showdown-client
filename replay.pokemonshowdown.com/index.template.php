...
<div>
	...
	<header>
		<div class="nav-wrapper"><ul class="nav">
			<li><a id="ps-link" class="button nav-first" href="//181.110.88.32:3001/"><img id="logo" src="//181.110.88.32:3001/images/pokemonshowdownbeta.png" srcset="//181.110.88.32:3001/images/pokemonshowdownbeta.png 1x, //181.110.88.32:3001/images/pokemonshowdownbeta@2x.png 2x" alt="Pok&eacute;mon Showdown" width="146" height="44" /> Home</a></li>
			<li><a id="dex-link" class="button" href="//181.110.88.32:3003/">Pok&eacute;dex</a></li>
			...
			<li><a id="play-link" class="button greenbutton nav-first nav-last" href="//181.110.88.32:3000/">Play</a></li>
		</ul></div>
	</header>
	<script>
