...
class PSSubscription {
    ...
    unsubscribe() {
        ...
        if (index >= 0)
            this.observable.subscriptions.splice(index, 1);
    }
}
/**
...
const PSBackground = new class extends PSStreamModel {
    ...
    set(bgUrl, bgid, menuColors = null) {
        // id
        this.id = bgid;
        // curid
        if (!bgid) {
