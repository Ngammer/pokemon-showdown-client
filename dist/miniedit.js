...
exports.MiniEditUndoPlugin = exports.MiniEditPastePlugin = exports.MiniEdit = void 0;
...
class MiniEdit {
    ...
    constructor(el, options) {
        ...
        // tslint:disable-next-line
        for (const Plugin of MiniEdit.plugins)
            new Plugin(this);
    }
    ...
    traverseText(node, callback) {
        if (node.nodeType === 3) {
            ...
            for (let i = 0, len = node.childNodes.length; i < len; ++i) {
                if (this.traverseText(node.childNodes[i], callback))
                    return true;
            }
        }
        return false;
...
exports.MiniEditPastePlugin = MiniEditPastePlugin;
...
exports.MiniEditUndoPlugin = MiniEditUndoPlugin;
