...
class TeamTextbox extends preact.Component {
    ...
    update = (cursorOnly) => {
        ...
        while (index < value.length) {
            ...
            if (index <= selectionStart && selectionEnd <= selectionEndCutoff) {
                ...
                else if (!lcLine || lcLine.startsWith('ivs:') || lcLine.startsWith('evs:') ||
                ...
                this.search.setType(this.activeType, 'gen8ou', this.sets[setIndex]);
                this.search.find('');
    ...
    render() {
        return <div class="teameditor">
			...
			<textarea class="textbox teamtextbox heighttester" style="visibility:hidden" tabIndex={-1} aria-hidden={true}/>
			<div class="teamoverlays">
				{this.setInfo.slice(0, -1).map(info => <hr style={`top:${info.bottomY - 18}px`}/>)}
                ...
                return <span class="picon" style={`top:${prevOffset + 1}px;left:50px;position:absolute;${iconStyle}`}></span>;
            })}
